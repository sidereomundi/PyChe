...
class GCEModel:
    ...
    def MinGCE(
        ...
        interp_cache_mass_points: int = 128,
        interp_cache_zeta_points: int = 96,
        interp_cache_binmax_points: int = 96,
        interp_cache_zeta_max: float = 0.05,
        interp_cache_guard: bool = False,
        interp_cache_guard_tol: float = 0.05,
        interp_cache_guard_stride: int = 32,
